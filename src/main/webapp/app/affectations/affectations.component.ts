...
export class AffectationsComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        if (this.currentSearch) {
            this.affectationsService
                ...
                .subscribe(
                    (res: HttpResponse<IAffectations[]>) => this.paginateAffectations(res.body, res.headers),
    ...
    trackId(index: number, item: IAffectations) {
        return item.id;
    }

    registerChangeInAffectations() {
        this.eventSubscriber = this.eventManager.subscribe('affectationsListModification', response => this.loadAll());
    }
    ...
    protected paginateAffectations(data: IAffectations[], headers: HttpHeaders) {
