import { VisTimelineGroups, VisTimelineItems, VisTimelineService } from './index';
...
describe('VisTimelineService Tests', () => {
    ...
    it('throws error when network already exists', () => {
        ...
        const items = new VisTimelineItems([
            { id: 1, content: 'item 1', start: '2016-04-20', group: 1 },
            { id: 2, content: 'item 2', start: '2016-04-14' },
            { id: 3, content: 'item 3', start: '2016-04-18', group: 1 },
            ...
            { id: 10, content: 'item 6', start: '2016-04-22', type: 'point' }
        ]);
        const groups = new VisTimelineGroups([{ id: 1, content: 'group1', title: 'title1' }]);
