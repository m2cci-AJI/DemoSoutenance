...
import { CollaboratorsComponent } from 'app/collaborators/collaborators.component';
...
describe('Component Tests', () => {
    describe('Collaborators Management Component', () => {
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(CollaboratorsComponent, '')
                .compileComponents();
